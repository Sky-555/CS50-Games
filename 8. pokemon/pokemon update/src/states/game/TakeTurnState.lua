                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        gStateStack:push(BattleMessageState('Congratulations! Level Up!', function()
                            gStateStack:push(StatsMenuState(self.battleState, self))
                        end))
                    else
                        self:fadeOutWhite()
                    end
...
function TakeTurnState:statsIncrease()
    return self.HPIncrease, self.attackIncrease, self.defenseIncrease, self.speedIncrease
end
